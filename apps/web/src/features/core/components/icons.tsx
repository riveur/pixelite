export function PixelPlayIcon(props: React.ComponentProps<'svg'>) {
  return (
...
export function PixelZapIcon(props: React.ComponentProps<'svg'>) {
  return (
    <svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
      <path
...
export function PixelTrophyIcon(props: React.ComponentProps<'svg'>) {
  return (
    <svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
      <path
...
export function PixelCloseIcon(props: React.ComponentProps<'svg'>) {
  return (
    <svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
      <path
...
export function PixelFrameDeleteIcon(props: React.ComponentProps<'svg'>) {
  return (
    <svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
      <path
...
export function PixelPercentIcon(props: React.ComponentProps<'svg'>) {
  return (
    <svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
      <path
...
export function PixelBedIcon(props: React.ComponentProps<'svg'>) {
  return (
    <svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
      <path
...
export function PixelUserPlusIcon(props: React.ComponentProps<'svg'>) {
  return (
    <svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
      <path
...
export function PixelUserMinusIcon(props: React.ComponentProps<'svg'>) {
  return (
    <svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
      <path
...
export function PixelAlertIcon(props: React.ComponentProps<'svg'>) {
  return (
    <svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
      <path
